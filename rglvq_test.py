#!/usr/bin/python3
"""
Tests the relational generalized learning vector quantization implementation
...
import proto_dist_ml.rglvq as rglvq
...
class TestRGLVQ(unittest.TestCase):

    def test_rgvlq1(self):
